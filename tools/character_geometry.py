...
import math
from portrait_geometry import enabled as has_portrait, build_head as build_portrait
...
def build_character(a):
    ...
    portrait = getattr(a,'reference_study',False) and has_portrait(a.key)
    ...
    if portrait:build_portrait(a,s)
    else:_head(a,s)
